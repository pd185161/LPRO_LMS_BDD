...
public class ClubServices extends BaseClass{

    com.LMS.LMSAPIAutomation.Payload.ClubServices ClubServices = new com.LMS.LMSAPIAutomation.Payload.ClubServices();

    @Given("Add ClubServices {string} request Payload")
    public void add_Session_payload(String scenario_name, io.cucumber.datatable.DataTable userTable) throws FileNotFoundException, JAXBException, TransformerException {
        ...
        add_payload(ClubServices.payload(scenario_name, Resources.parameters,userTable),HttpHeaders,"text/xml;charset=UTF-8");
    }
